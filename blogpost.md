...
#### E(3) Steerable GNN
Here we use a take the 14-dimentional node embedding of the long-range PascalVOC-SP and COCO-SP datasets and add another dimention of zeros to it thus making it 15-dimentional. Further we break down the node embedding into 12 type-0 vectors and 1 type-1 vector. 
